...
def move_doc_to_shelf():
    user_doc_number = get_input('Введите номер документа - ')
    user_shelf_number = get_input('Введите номер полки для перемещения - ')
...
def add_new_doc():
    new_doc_number = get_input('Введите номер документа - ')
    new_doc_type = get_input('Введите тип документа - ')
    new_doc_owner_name = get_input('Введите имя владельца документа- ')
    new_doc_shelf_number = get_input('Введите номер полки для хранения - ')
    new_doc = {
        "type": new_doc_type,
